...
(function () {
  ...
  var author = " ZM";
  var github = " https://github.com/MikeWeiZhou";
...
blog.initClickEffect = function (textArr) {
  ...
  blog.addEvent(window, "click", function (ev) {
    ...
    setTimeout(function () {
      dom.style.transition = "transform 3500ms ease-out, opacity 3500ms ease-out";
      dom.style.webkitTransition = "transform 3500ms ease-out, opacity 3500ms ease-out";
      dom.style.opacity = 0;
...
blog.addLoadEvent(function () {
  ...
  function initDarkMode(flag) {
    if (flag === "true") $icon.textContent = "dark_mode";
